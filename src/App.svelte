...
<main>
    <Title class="mt-12">IHRE <b>PROFESSIONELLE</b>, <b>HANDGEMACHTE</b> WEBSITE AUS WIEN</Title>
    
    <Center class="mt-14 space-x-5" horizontal={false}>
        <Panel
            header="AB"
    ...
    <Hr color="panel/40" class="my-12" width="2/3"></Hr>
</main>
